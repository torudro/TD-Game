...
class Enemy:
    ...
    def draw(self):
        ...
        # self.list_counter = 0
        self.incr_x = self.enemy_path_list_x[self.list_counter] + enemy_track.dist_x_list[self.list_counter] * (
                    1 / self.speed)

        self.incr_y = self.enemy_path_list_y[self.list_counter] + enemy_track.dist_y_list[self.list_counter] * (
                    1 / self.speed)
        self.decr_y = self.enemy_path_list_y[self.list_counter] - enemy_track.dist_y_list[self.list_counter] * (
                    1 / self.speed)
